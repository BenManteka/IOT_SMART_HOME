...
# DB init data
db_name = 'data\\FitGuard.db'  
db_init = False   # True רק אם צריך לאתחל DB מאפס

# Meters consumption limits 
sensitivityMax = 0.03   # היה: 0.02
Elec_max = 2.0          # היה: 1.8
